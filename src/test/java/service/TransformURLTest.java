...
public class TransformURLTest {
    ...
    @Test
    public void testSuccessEditHostLocalHost() {
        String host = "http://localhost:5342/";
        Assert.assertEquals("localhost:5342",transformURL.editHost(host));
    }

    @Test
    public void testSuccessgetHostWithProtocol() {
        String host = "http://java-online.ru/aaaaaaa";
        Assert.assertEquals("http://java-online.ru",transformURL.getHostWithProtocol(host));
    }
